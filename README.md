# CHM 全国 34 城二手房底部信号监测

> 这是一个观察 34 城二手房"底部信号"的开源仪表盘。
> 它不预测房价，也不构成买房建议，只把官方价格指数、收储事件、央行资金进度和挂牌数据放在一起，帮助普通人更透明地看市场。

**[在线预览 →](https://opc-mind.top/chm)**

![CHM 仪表盘截图](docs/screenshot.png)
